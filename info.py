...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002276798827').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002276798827').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https//t.me/mawh_verify')  # How to open tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+6U0jQ3ZP37A2Mjhl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Cineworldorzz')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/punisherbr0')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+5Se-_5zHmhQwYmRl')

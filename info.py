...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6349283920 7813216178 6350827518 7589671434').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002607216671').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002630592085'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002630592085'))  # Bin channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002823187819'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002630592085'))  # Premium logs channel id
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002641268011').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002641268011').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/PPG.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'mawh1@upi')
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002630592085'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/MAWH_Verify/21')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', '7337a3f2a82cc5d7060bb10a12127f68c89d5d33')
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MoviesAndWebseriesRequestGc')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/moviesandwebserieshubOrzz')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/punisherbr0')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+gskWCOXIbvo0MDc1')
OWNERID = int(os.environ.get('OWNERID', '8168001137'))  # Replace with the actual admin ID
